...
class RiverpodAppView2 extends StatefulWidget {
  final String title;
  final Color color;
  const RiverpodAppView2({Key? key, required this.title, required this.color}) : super(key: key);

  @override
  _BlocAppView2State createState() => _BlocAppView2State();
}

class _BlocAppView2State extends State<RiverpodAppView2> {
  @override
